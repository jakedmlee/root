...
class TotpRecoveryController @Inject() (
  ...
  totpRecovery: views.html.totpRecovery)(implicit ex: ExecutionContext) extends AbstractAuthController(scc) {
   ...
   */
  def view(userID: UUID, sharedKey: String, rememberMe: Boolean) = {
