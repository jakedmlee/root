...
class TotpController @Inject() (
  ...
  home: views.html.home)(implicit ex: ExecutionContext) extends AbstractAuthController(scc) {

  /**
   * Views the `TOTP` page.
   * @return The result to display.
   */
  def view(userId: java.util.UUID, sharedKey: String, rememberMe: Boolean) = {
